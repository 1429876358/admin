  ...
  data() {
    return {
      datalist: [
        ...
        {
          reachId: '2024',
          startLon: '120.3797679716',
          startLat: '30.1718863971',
          isRiver: '0',
          reachName: '郭家埠直河'
        },
        {
        ...
        {
          reachId: '1840',
          startLon: '120.3321506539',
          startLat: '30.3023436818',
          isRiver: '0',
          reachName: '1号渠'
        },
        {
        ...
        {
          reachId: '874',
          startLon: '120.28872202411232',
          startLat: '30.19273306726234',
          isRiver: '0',
          reachName: '北塘河（北干段）'
        },
        {
  ...
  methods: {
    init() {
      ...
      var imageLayer = new AMap.ImageLayer({
        ...
        // url: 'http://192.168.1.124:8081/geoserver/sys/wms?LAYERS=sys%3Azhen_polygon&STYLES=&FORMAT=image%2Fpng&SERVICE=WMS&VERSION=1.1.1&REQUEST=GetMap&SRS=EPSG%3A4326&BBOX=117.84590625,28.926442578125,121.067,30.621755078125&WIDTH=1900&HEIGHT=1000',
    ...
    // 清除所有矢量点
    removeMarkers() {
      this.map.remove(this.markers_1)
    },
    addMarkers() {
      var that = this
      for (var i = 0; i < this.datalist.length; i++) {
        var marker = new AMap.Marker({
          position: new AMap.LngLat(
            Number(this.datalist[i].startLon),
            Number(this.datalist[i].startLat)
          ),
        ...
        marker.content = that.createInfoWindow()
